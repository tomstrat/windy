...
import {formatDirection, removeInnerObject} from "./formatters/formatters.ts"
import TEST_DATA from "./testdata.ts"

const API_KEY = "84159e48-6bfd-11ec-a58f-0242ac130002-84159ec0-6bfd-11ec-a58f-0242ac130002"
const LAT = "53.2290"
const LNG = "4.5198"
const PARAMS = "airTemperature,pressure,currentSpeed,gust,swellHeight,swellPeriod,waterTemperature,waveHeight,wavePeriod,windDirection,windSpeed"
...
const result = R.pipe(
               ...
               R.map(formatDirection("windDirection"))
)(body.hours)
